...
module DigestionTests =
    ...
    let digestionTests  =
        ...
        testList "Digestion" [
            ...
            testCase "concernMissCleavages - BioSeq" (fun () ->
            ...
            testCase "concernMissCleavages - BioArray" (fun () ->
                let withMissCleavages =
            ...
            testCase "concernMissCleavages - BioList" (fun () ->
                let withMissCleavages =
