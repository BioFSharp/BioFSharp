...
open BioFSharp.FileFormats.ClustalOCLI
open BioFSharp.FileFormats.ClustalOCLI.Parameters
open FSharpAux
open System.IO
open System.Text
...
module ClustalOCLI =
    ...
    let private tsToFasta (ts:TaggedSequence<string,char>) = Fasta.FastaItem.create ts.Tag ts.Sequence 
