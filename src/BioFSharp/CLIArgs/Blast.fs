...
module Blast =
    ...
    type MakeBlastDBInputType =
        ...
        static member toCLIString = function
            |Fasta      -> "fasta"
            |Blastdb    -> "blastdb"
            |Asn1Txt    -> "asn1_txt"
            |ASN1Bin    -> "asn1_bin"
    ...
    type MakeBlastDbParams =
        ...
        static member toCLIArgs = function
            | Input  (path)         -> ["-in"           ; path]
            | InputType it          -> ["-input_type"   ; MakeBlastDBInputType.toCLIString it]
            | DbType (dbt)          -> ["-dbtype"       ; DbType.toCLIString dbt]
            | Title t               -> ["-title"        ; t]
    ...
    type BlastParams =
        ...
        static member toCLIArgs  = function
            ...
            | Output            (path)      -> ["-out"   ; path]
            | OutputType        (format)    -> ["-outfmt"; string (format |> OutputType.toCLIString)]
            | OutputTypeCustom  (t,p)       -> 
                let tmp = 
                    p 
                    |> Seq.map OutputCustom.toCLIString 
                    |> String.concat " "
                match t with
                | OutputType.Tabular             -> ["-outfmt"; sprintf "%s %s" (string (t |> OutputType.toCLIString)) tmp]
                | OutputType.TabularWithComments -> ["-outfmt"; sprintf "%s %s" (string (t |> OutputType.toCLIString)) tmp]
                | OutputType.CSV                 -> ["-outfmt"; sprintf "%s %s" (string (t |> OutputType.toCLIString)) tmp]
    ...
    module BlastN =
        ...
        type MegablastParameters =  
            ...
            static member toCLIArgs = function
                ...
                | SpecificOptions   l -> l |> List.map MegablastParams.toCLIArgs |> List.concat
        ...
        type DCMegablastParameters =  
            ...
            static member toCLIArgs = function
                | CommonOptions     l -> l |> List.map BlastParams.toCLIArgs     |> List.concat
                | SpecificOptions   l -> l |> List.map DCMegablastParams.toCLIArgs |> List.concat
        ...
        type BlastNParameters =  
            ...
            static member toCLIArgs = function
                | CommonOptions     l -> l |> List.map BlastParams.toCLIArgs     |> List.concat
                | SpecificOptions   l -> l |> List.map BlastNParams.toCLIArgs |> List.concat
        ...
        type BlastNShortParameters =  
            ...
            static member toCLIArgs = function
                | CommonOptions     l -> l |> List.map BlastParams.toCLIArgs     |> List.concat
                | SpecificOptions   l -> l |> List.map BlastNShortParameters.toCLIArgs |> List.concat
    ...
    module BlastP =
        ...
        type BlastPParameters =
            ...
            static member toCLIArgs = function
                | CommonOptions     l -> l |> List.map BlastParams.toCLIArgs     |> List.concat
                | SpecificOptions   l -> l |> List.map BlastPParams.toCLIArgs |> List.concat
        ...
        type BlastPShortParameters =
            ...
            static member toCLIArgs = function
                | CommonOptions     l -> l |> List.map BlastParams.toCLIArgs     |> List.concat
                | SpecificOptions   l -> l |> List.map BlastPShortParams.toCLIArgs |> List.concat
